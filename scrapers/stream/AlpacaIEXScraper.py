...
class StockScraper():
    def __init__(self, stock):
        ...
        # Read here for more context on below https://massive.com/glossary/conditions-indicators

        # For Aggregation/ML applications
        self.bar_data = pd.DataFrame(columns=["timestamp",
                                              "open", 
                                              "high", 
                                              "low", 
                                              "close", 
        ...
        self.quote_data = pd.DataFrame(columns=["timestamp", 
                                                "bid_price", 
                                                "bid_size", 
                                                "bid_exchange", 
                                                "ask_price", 
                                                ...
                                                "conditions", 
                                                "tape"])
        self.trade_data = pd.DataFrame(columns=["timestamp", 
                                                "exchange", 
                                                "price", 
                                                "size", 
                                                "id", 
